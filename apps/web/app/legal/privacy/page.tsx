...
export default function PrivacyPage() {
  return (
    <article className="max-w-3xl space-y-5 text-sm leading-relaxed text-slate-300">
      ...
      <section>
        <h2 className="font-semibold text-white mb-1">1. 取得する情報</h2>
      ...
      <section>
        <h2 className="font-semibold text-white mb-1">2. 利用目的</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section>
        <h2 className="font-semibold text-white mb-1">3. 第三者提供・委託</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold text-white mb-1">4. 保存期間・開示等の請求</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold text-white mb-1">5. Cookie等</h2>
        <p>
